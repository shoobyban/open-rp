...
LIBS=-mwindows -Wl,-Bsymbolic $(LIBDIR)/libSDLmain.a $(LIBDIR)/libSDL.a $(LIBDIR)/libSDL_image.a $(LIBDIR)/libpng.a $(LIBDIR)/libz.a $(LIBDIR)/libSDL_net.a $(LIBDIR)/libSDL_ttf.a $(LIBDIR)/libfreetype.a $(LIBDIR)/libcrypto.a $(LIBDIR)/libavformat.a $(LIBDIR)/libavcodec.a $(LIBDIR)/libswscale.a $(LIBDIR)/libavutil.a $(LIBDIR)/libfaad.a $(LIBDIR)/libcurl.a $(LIBDIR)/libdxguid.a $(LIBDIR)/libz.a -lwsock32 -lgdi32 -lwinmm -lmingw32
